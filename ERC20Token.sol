...
// File contracts/HYBEX.sol

// 



contract FTHYX is ERC20Upgradeable, PausableUpgradeable {
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "FTHYX: ONLY OWNER");
        _;
    }

    modifier onlyMinter() {
        require(msg.sender == minter, "FTHYX: ONLY MINTER");
        _;
    }
